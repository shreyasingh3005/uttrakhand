                ...
                <div class="card p-4 shadow-sm border-0" style="border-radius: 8px; background: #fff;">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="bookingQueryLocation" list="hotelCityList" placeholder="Type a city, e.g. gur..." value="" autocomplete="off">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" id="bookingQueryHotelCategory">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="date" class="form-control" id="bookingQueryCheckIn">
                        </div>
                        <div class="col-md-4">
                            <label for="bookingQueryCheckOut" class="form-label small fw-semibold text-secondary">Check-out</label>
                            <input type="date" class="form-control" id="bookingQueryCheckOut">
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="number" class="form-control" id="bookingQueryAdults" min="1" value="1">
                        </div>
                        <div class="col-md-3">
                            <label for="bookingQueryChildren" class="form-label small fw-semibold text-secondary">Children</label>
                            <input type="number" class="form-control" id="bookingQueryChildren" min="0" value="0">
                        </div>
                        <div class="col-md-3">
                            <label for="bookingQueryRooms" class="form-label small fw-semibold text-secondary">Rooms</label>
                            <input type="number" class="form-control" id="bookingQueryRooms" min="1" value="1">
                        </div>
                        <div class="col-md-3">
