...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item"><a class="nav-link" data-target="search-agent-view" href="#" onclick="showSection('search-agent-view'); return false;"><i class="bi bi-person-badge"></i> Agents</a></li>
